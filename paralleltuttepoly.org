...
#+begin_src bash :dir /ssh:andrew:paralleltuttepoly :results raw drawer
make clean
make execute
#+end_src
...
:RESULTS:
make -C nauty clean
make[1]: Entering directory `/afs/andrew.cmu.edu/usr4/akyle/nauty26r10'
rm -f *.o config.log config.cache config.status nauty*.a
rm -f dreadtest dreadtestL \
	dreadtestW \
	dreadtestS dreadtestS1 \
        dreadtest4K dreadtest1 \
	dreadtestL1 dreadtestW1
make[1]: Leaving directory `/afs/andrew.cmu.edu/usr4/akyle/nauty26r10'
rm -f tutte *.o
:END:
